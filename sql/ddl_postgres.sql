...
create table if not exists dim_market (
  market_id integer generated by default as identity primary key,
...
create table if not exists stg_provider_ops_record (
  stg_record_id integer generated by default as identity primary key,
  run_id integer not null references etl_run(run_id),
...
create table if not exists fact_validation_issue (
  validation_issue_id integer generated by default as identity primary key,
  run_id integer not null references etl_run(run_id),
